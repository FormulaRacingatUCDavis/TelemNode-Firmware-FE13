...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  if(htim_base->Instance==TIM1)
  {
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = WHEEL_SPEED1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(WHEEL_SPEED1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM1)
  {
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(WHEEL_SPEED1_GPIO_Port, WHEEL_SPEED1_Pin);
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PA0-WKUP     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(WHEEL_SPEED2_GPIO_Port, WHEEL_SPEED2_Pin);
